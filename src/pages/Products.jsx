...
function Products() {
    ...
    const filterRef = useRef(null); // Ref for filter dropdown and button
    ...
    return (
        <>
            <div className="w-full flex flex-wrap justify-center relative">
                {price > 0 && (
                    <div ref={filterRef} className="flex align-center absolute start-0 top-[20px]">
                        <button
                        ...
                        <div
                            className={`flex flex-col gap-[30px] px-[20px] absolute w-min top-[20px] left-[80px] right-0 mb-[20px] z-10 border border-gray-300 rounded-md shadow-[#424242] shadow-lg p-[15px] bg-white h-[300px] ${
                                show ? "" : "hidden"
                            }`}
                        >
                            <div className="font-bold text-[24px]">Filters</div>
                            <RangeSlidersComponent price={price} changePrice={changePrice} />
